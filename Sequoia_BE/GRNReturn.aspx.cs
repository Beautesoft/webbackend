        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.QueryString["PKey"] != null)
                {
                    ...
                    btnSubmit_AddGRNReturn.InnerText = "Edit";
                    ...
                    using (var client = new HttpClient())
                    {
                        ...
                        if (response.IsSuccessStatusCode)
                        {
                            ...
                            dt_DocDateGRNReturn.Value =Convert.ToDateTime(StkMovdocHdrsVal[0].docDate).ToString("dd/MM/yyyy");
                            ...
                            dt_DeliveryDateGRNReturn.Value = Convert.ToDateTime(StkMovdocHdrsVal[0].docDate).ToString("dd/MM/yyyy");
                            ...
                            txt_TotAmntGRNReturn.Value = StkMovdocHdrsVal[0].docAmt;
