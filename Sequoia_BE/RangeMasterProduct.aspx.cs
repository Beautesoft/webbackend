...
namespace Sequoia_BE
{
    public partial class RangeMasterProduct : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (Request.QueryString["PKey"] != null)
                {
                    using (var client1 = new HttpClient())
                    {
                        ...
                        //GET Method  
                        bool val = true;
                        string api = "api/itemBrands?filter={\"where\":{\"retailProductBrand\":\"" + val + "\",\"itmStatus\":\"" + val + "\"}}";
        ...
        [WebMethod]
        public static void AddRangeMasterProductData(string itmCode, string itmDesc, bool itmStatus, string itmBrand, string siteCode)
        {
            using (var client = new HttpClient())
            {
