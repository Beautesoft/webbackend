        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.QueryString["PKey"] != null)
                {
                    ...
                    btnSubmit_AddGRN.InnerText = "Edit";
                    ...
                    using (var client = new HttpClient())
                    {
                        ...
                        if (response.IsSuccessStatusCode)
                        {
                            ...
                            dt_DocDateGRN.Value =Convert.ToDateTime(StkMovdocHdrsVal[0].docDate).ToString("dd/MM/yyyy");
                            ...
                            dt_DeliveryDateGRN.Value = Convert.ToDateTime(StkMovdocHdrsVal[0].docDate).ToString("dd/MM/yyyy");
                            ...
                            txt_TotAmntGRN.Value = StkMovdocHdrsVal[0].docAmt;
