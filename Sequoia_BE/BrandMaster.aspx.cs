...
namespace Sequoia_BE
{
    public partial class BrandMaster : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.QueryString["PKey"] != null)
                {
                    ...
                    btnSubmit_AddBrandMaster.InnerText = "Update";
        ...
        [WebMethod]
        public static void AddBrandMasterData(string itmCode, string itmDesc, bool itmStatus, bool retailProductBrand, bool voucherBrand, bool prepaidBrand, string siteCode)
        {
            using (var client = new HttpClient())
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    using (var client1 = new HttpClient())
                    {
                        ...
                        ControlNosUpdate c = new ControlNosUpdate { controldescription = "BRAND CODE", sitecode = siteCode, controlnumber = Convert.ToString(NewcontrolNo) };
