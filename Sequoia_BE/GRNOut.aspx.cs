    ...
    public partial class GRNOut : System.Web.UI.Page
    {
        ...
        private void LoadValue()
        {
            ...
            try
            {
                ...
                ddlStoreCode_GRNOut.Items.Add(new ListItem("Select your option", ""));
                foreach (DataRow oDr in oDT_General.Rows)
                {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        if (response.IsSuccessStatusCode)
                        {
                            ...
                            ControlNosUpdate c = new ControlNosUpdate { controldescription = "Transfer To Other Store", controlnumber = Convert.ToString(NewcontrolNo) };
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.QueryString["PKey"] != null)
                {
                    ...
                    btnSubmit_AddGRNOut.InnerText = "Edit";
                    ...
                    using (var client = new HttpClient())
                    {
                        ...
                        if (response.IsSuccessStatusCode)
                        {
                            ...
                            dt_DocDateGRNOut.Value =Convert.ToDateTime(StkMovdocHdrsVal[0].docDate).ToString("dd/MM/yyyy");
                            if (StkMovdocHdrsVal[0].recStatus == "0")
                            {
                            ...
                            txt_TotAmntGRNOut.Value = StkMovdocHdrsVal[0].docAmt;
                            ddl_FromStoreGRNOut.Value = StkMovdocHdrsVal[0].fstoreNo;
                            ddl_ToStoreGRNOut.Value = StkMovdocHdrsVal[0].tstoreNo;
