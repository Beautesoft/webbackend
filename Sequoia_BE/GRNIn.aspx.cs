                ...
                using (var client = new HttpClient())
                {
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        if (response.IsSuccessStatusCode)
                        {
                            ...
                            ControlNosUpdate c = new ControlNosUpdate { controldescription = "Transfer From Other Store", controlnumber = Convert.ToString(NewcontrolNo) };
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.QueryString["PKey"] != null)
                {
                    ...
                    btnSubmit_AddGRNIn.InnerText = "Edit";
                    ...
                    using (var client = new HttpClient())
                    {
                        ...
                        if (response.IsSuccessStatusCode)
                        {
                            ...
                            dt_DocDateGRNIn.Value =Convert.ToDateTime(StkMovdocHdrsVal[0].docDate).ToString("dd/MM/yyyy");
                            ...
                            txt_TotAmntGRNIn.Value = StkMovdocHdrsVal[0].docAmt;
                            ddl_FromStoreGRNIn.Value = StkMovdocHdrsVal[0].fstoreNo;
                            ddl_ToStoreGRNIn.Value = StkMovdocHdrsVal[0].tstoreNo;
