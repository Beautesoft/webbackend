                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                             <div class="form-group required">
                                ...
                                <input type="text" runat="server" class="form-control pull-right" id="dt_DocDateStockAdj"  >
                            </div>
                            </div>
                     </div>  
                                            <div class="col-md-4">
                ...
                <br />
                    ...
                    <tbody>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                   <input type="number" maxlength="50" runat="server" class="form-control" id="txt_TotAmntStockAdj" style="text-align:left" readonly="readonly">
                                </div>
                                <div class="col-md-2">
