...
namespace Sequoia_BE
{
    public partial class ClassMaster : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.QueryString["PKey"] != null)
                {
                    ...
                    btnSubmit_AddClassMaster.InnerText = "Update";
        ...
        [WebMethod]
        public static void ClassMasterCall(string Code, string Name, bool InActive,string siteCode)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    {
                        int NewcontrolNo = int.Parse(Code) + 1;
