...
namespace Sequoia_BE
{
    public partial class RangeMasterCompound : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static void AddRangeMasterCompoundData(string itmCode, string itmDesc, bool itmStatus, string itmDept, string siteCode)
        {
            using (var client = new HttpClient())
            {
        ...
        public static void EditAddRangeMasterCompoundData(string itmCode, string itmDesc, bool itmStatus, string itmDept)
        {
            using (var client = new HttpClient())
            {
                RangeMasterProductInput p = new RangeMasterProductInput { itmCode = itmCode, itmDesc = itmDesc, itmStatus = itmStatus, itmDept = itmDept, isproduct = false, prepaidForProduct = false, prepaidForService = false, prepaidForAll = false, isservice = true, isvoucher = false, isprepaid = false, iscompound = true };
                client.BaseAddress = new Uri(System.Configuration.ConfigurationManager.AppSettings["uri"]);
                client.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
