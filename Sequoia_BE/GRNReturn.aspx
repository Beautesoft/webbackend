                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                             <div class="form-group required">
                                ...
                                <input type="text" runat="server" class="form-control pull-right" id="dt_DocDateGRNReturn"  >
                            </div>
                            </div>
                     </div>  
                                            <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                             <div class="form-group required">
                                ...
                                <input type="text" runat="server" class="form-control pull-right" id="dt_DeliveryDateGRNReturn"  >
                            </div>
                            </div>
                     </div>  
                                            <div class="col-md-4">
                             <div class="form-group required">
                                ...
                                <input type="number" class="form-control" runat="server" id="txtTerm_GRNReturn" value="0">
                            </div>
                     </div>  
                ...
                <div class="nav-tabs-custom">
                    ...
                    <tbody>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                   <input type="number" maxlength="50" runat="server" class="form-control" id="txt_TotAmntGRNReturn" style="text-align:left" readonly="readonly">
                                </div>
                                <div class="col-md-2">
